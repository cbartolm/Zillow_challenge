...
## Models ####
base_line = lm(logerror ~ calculatedfinishedsquarefeet, data=testing) # most correlated variable
all_coeff = lm(logerror ~ ., data=testing)

best_model_step_wise = lm(logerror ~ calculatedfinishedsquarefeet + taxamount +
                            taxdelinquencyflag + tract_county + bedroomcnt, data=testing)
bes_model_interactions = lm(logerror ~ calculatedfinishedsquarefeet + taxamount +
                              ...
                              taxamount:structuretaxvaluedollarcnt + taxamount:lotsizesquarefeet, data=testing)

bes_model_interactions_test = lm(logerror ~ calculatedfinishedsquarefeet + taxamount +
                              taxdelinquencyflag + tract_county + bedroomcnt + calculatedfinishedsquarefeet:taxamount +
                              calculatedfinishedsquarefeet:structuretaxvaluedollarcnt +
                              taxamount:structuretaxvaluedollarcnt + taxamount:lotsizesquarefeet, data = testing)
...
#   zero_one_loss_testing = 1/nrow(testing)*sum(is_missclassifsuied_testing)
#   
#   
